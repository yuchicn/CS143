 ...
 * Description  A class for a add Opera dialog to add a new Opera to the 
 * operasdatabase
...
public class AddOpera extends javax.swing.JDialog {
    ...
    /**
     * Method  AddOpera
     * Description  Default constructor of AddOpera.Creates new form 
     * AddOpera form centered, with save button as default.
     * @param parent
     * @param modal
     */
     ...
     * Description  Event handler for the save button. Create a new Ballet 
     * object newBallets with all the fields. 
 ...
 /*   public static void main(String args[]) {
        ...
        /*try {
            ...
            java.util.logging.Logger.getLogger(AddOpera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
     ...
     /*   java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddOpera dialog = new AddOpera(new javax.swing.JFrame(), true);
